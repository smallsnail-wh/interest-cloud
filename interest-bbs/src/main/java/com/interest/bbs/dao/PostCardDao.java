...
public interface PostCardDao {
    ...
    List<PostCardVO> postcardList(@Param("interestId") int interestId, @Param("pageSize") int pageSize,
                                  @Param("start") int start);

    Integer postcardSize(@Param("interestId") int interestId, @Param("pageSize") int pageSize,
                         @Param("start") int start);
